...
class Go2BenchMlp(GO2):
    ...
    The deployable actor receives the unchanged 45-dimensional GO2 proprioceptive
    observation. The critic additionally receives the noise-free true base linear
    velocity: ``[actor_obs(45), base_lin_vel(3)]``.
    """
